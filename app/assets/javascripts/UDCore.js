...
var ComponentStyle = {text_color: "#000000",font_size: "12px",font_width: 7,line_height: 13,component_color: "#00000"};
...
Text.prototype.setText = function(a) {
    if (JSFun.isString(a)) {
        ...
        if (a == "") {
            ...
            if (this._orientation) {
                this.setHeight(this._text.length * ComponentStyle.font_width)
            } else {
                this.setWidth(this._text.length * ComponentStyle.font_width)
            }
        }
        if (this._orientation) {
            this.setWidth(ComponentStyle.line_height)
        } else {
            this.setHeight(ComponentStyle.line_height)
        }
    }
};
Text.prototype.draw = function(a) {
    ...
    a.save();
    a.font = ComponentStyle.font_size + " monospace";
    a.textBaseline = "middle";
    a.fillStyle = ComponentStyle.text_color;
    if (this._orientation) {
        a.translate(this._getMX() + ComponentStyle.line_height / 2, this._getMY());
        a.rotate((-90 * Math.PI) / 180);
        a.fillText(this._text, this._margin * 2 - this.getHeight(), 0)
    } else {
        a.fillText(this._text, this._getMX(), this._getMY() + ComponentStyle.line_height / 2)
    }
    a.restore()
};
...
RoundedRectangleFigure.prototype.draw = function(d, c, f, e, b) {
    ...
    d.restore();
    d.save();
    d.strokeStyle = figureStyle.border;
    d.beginPath();
    d.moveTo(c + a, f);
    d.lineTo(c + e - a, f);
    d.quadraticCurveTo(c + e, f, c + e, f + a);
...
RegionFigure.prototype.draw = function(b, h, f, a, j, d, g, c) {
    ...
    j += d;
    b.save();
    b.strokeStyle = figureStyle.border;
    b.beginPath();
...
var FromImageFigure = function(a) {
    a = a || {};
    FromImageFigure.baseConstructor.call(this, a);
    if (a.route) {
        this.route = a.route;
...
FromImageFigure.prototype.draw = function(c, b, g, d, a) {
    if (this.load) {
        try {
            c.drawImage(this.image, b, g, d, a)
        } catch (f) {
        }
        var e = this;
        this.image.onload = function() {
            if (e.parent._diagram._selected) {
                c.drawImage(this, b, g, d, a)
            }
        }
    }
};
...
Node.prototype.getElementXML = function(b) {
    ...
    c.setAttribute("width", this._beforeWidth || this.getWidth());
    c.setAttribute("height", this._beforeHeight || this.getHeight());
...
Node.prototype.setSelectedFigure = function(c) {
    if (JSFun.isNumber(c) && c > -1 && c < this._figures.length) {
        if (this._selectedFigure == c) {
            return false
        }
        this._selectedFigure = c;
        if (this._figures[c] instanceof FromImageFigure) {
            for (var a = 0; a < this._components.length; a++) {
                if (this._components[a]._id == "name") {
                    if (!this._beforeNameComponent) {
                        this._beforeNameComponent = this._components[a];
                        var d = this._beforeNameComponent._text;
                        var b = this._beforeNameComponent.selected;
                        if (this._beforeNameComponent instanceof TextArea) {
                            this._components[a] = new TextArea({id: "name",text: d.join("\n"),selected: b,position: Component.Bottom,margin: 3})
                        }
                        if (this._beforeNameComponent instanceof TextBox) {
                            this._components[a] = new TextBox({id: "name",text: d,selected: b,position: Component.Bottom,margin: 3})
                        }
                        this._components[a].setParent(this)
                    }
                } else {
                    this._components[a].setVisibility(false)
                }
            }
            this._beforeHeight = this._height;
            this._beforeWidth = this._width;
            for (a = 0; a < this._nodeChilds.length; a++) {
                this._nodeChilds[a].setVisibility(false)
            }
        } else {
            for (var a = 0; a < this._components.length; a++) {
                if (this._components[a]._id == "name") {
                    if (this._beforeNameComponent) {
                        if (this._beforeNameComponent instanceof TextArea) {
                            this._beforeNameComponent.setText(this._components[a]._text.join("\n"))
                        } else {
                            if (this._beforeNameComponent instanceof TextBox) {
                                this._beforeNameComponent.setText(this._components[a]._text)
                            }
                        }
                        this._components[a] = this._beforeNameComponent;
                        this._beforeNameComponent = null
                    }
                } else {
                    if (!(this._components[a] instanceof SpecificationItem) || this._components[a] instanceof SpecificationItem && this._components[a].getValue() != "") {
                        this._components[a].setVisibility(true)
                    }
                }
            }
            for (a = 0; a < this._nodeChilds.length; a++) {
                this._nodeChilds[a].setVisibility(true)
            }
...
Node.prototype.deleted = function() {
    var a;
    while (this._relations[0]) {
        (this._relations.pop()).deleted()
    }
    if (this._parent) {
        var b = this._parent;
...
SolidLine.prototype.draw = function(c, d, a) {
    var b;
    c.save();
    c.strokeStyle = a;
    c.lineWidth = 1.25;
    c.beginPath();
    c.moveTo(d[0].pixelX(), d[0].pixelY());
    for (b = 1; b < d.length; b++) {
        c.lineTo(d[b].pixelX(), d[b].pixelY())
    }
    c.stroke();
    c.restore()
};
...
DashedLine.prototype.draw = function(c, d, a) {
    var b;
    c.save();
    c.strokeStyle = a;
    c.lineWidth = 1.25;
    for (b = 0; b < d.length - 1; b++) {
        JSGraphic.dashedLine(c, d[b].pixelX(), d[b].pixelY(), d[b + 1].pixelX(), d[b + 1].pixelY(), 10)
    }
    c.restore()
};
...
var RelationStyle = {shape_color: "#000000",line_color: "#000000"};
...
Relation.prototype.setElementXML = function(g, e) {
    var c = g.getAttribute("side_A");
    var a = g.getAttribute("side_B");
    this.setElements(e[c], e[a]);
    var d;
    var f = g.childNodes;
    var h = 0;
    for (d = 0; d < f.length; d++) {
        if (f[d].nodeName == "point") {
            this._points[h] = new Point(parseInt(f[d].getAttribute("x")), parseInt(f[d].getAttribute("y")));
            h++
        }
    }
    for (d = 0; d < f.length; d++) {
        if (f[d].nodeName == "item") {
            this.setValue(f[d].getAttribute("id"), f[d].getAttribute("value"))
        } else {
            if (f[d].nodeName == "superitem") {
                var b;
                for (b in this._components) {
                    if (this._components[b].getId() == f[d].getAttribute("id")) {
                        this._components[b].setComponentXML(f[d])
                    }
                }
            }
        }
...
Relation.prototype.select = function(a, c) {
...
Relation.prototype.draw = function(b) {
    ...
    if (this._line) {
        this._line.draw(b, this._points, RelationStyle.line_color)
    }
    if (this._end) {
        ...
        this._end.draw(b, g, e, f, RelationStyle.line_color)
    }
    if (this._start) {
        ...
        var f = Math.atan2(e - c, g - d);
        this._start.draw(b, g, e, f, RelationStyle.line_color)
    }
    if (this._selected >= 0) {
        var a;
...
Relation.prototype.deleted = function() {
    var a;
    while (this._relations[0]) {
        (this._relations.pop()).deleted()
    }
...
Diagram.prototype.select = function() {
    this._selected = true
};
Diagram.prototype.deselect = function() {
    this._selected = false
};
...
TextArea.prototype.setText = function(d) {
    if (JSFun.isString(d)) {
        ...
        if (d == "") {
            ...
            this.setWidth(c * ComponentStyle.font_width)
        }
        this.setHeight(this._text.length * ComponentStyle.line_height)
    }
};
...
TextArea.prototype.draw = function(d) {
    ...
    d.font = ComponentStyle.font_size + " monospace";
    d.textBaseline = "middle";
    d.fillStyle = ComponentStyle.text_color;
    var a = this._getMX();
    var f = this._getMY() + ComponentStyle.line_height / 2;
    var b = this.getWidth() - 2 * this._getMargin();
    var e = 0;
    var c;
    for (c = 0; c < this._text.length; c++) {
        e = a + b / 2 - (this._text[c].length * ComponentStyle.font_width) / 2;
        d.fillText(this._text[c], e, f);
        f += ComponentStyle.line_height
    }
    d.restore()
};
...
GuardItem.prototype.draw = function(d) {
    ...
    d.fillStyle = ComponentStyle.text_color;
    var a = this._getMX();
    var e = this._getMY() + ComponentStyle.line_height / 2;
    var b = this.getWidth() - 2 * this._getMargin();
    var c;
    for (c = 0; c < this._text.length; c++) {
        d.fillText(this._text[c], a, e);
        e += ComponentStyle.line_height
    }
    d.restore()
};
var Tab = function(a) {
...
SuperNode.prototype.notifyChange = function(f, c, e) {
    ...
    e = e || false;
    this._resizing = true;
    if (this._nodeChilds[0] && this._nodeChilds[0]._visible) {
        this.updateRegions(c, e)
    }
    if (this._container) {
        var d;
        if (f && this._nodeChilds[0] && this._nodeChilds[0]._visible) {
...
SuperNode.prototype.setSelectedFigure = function(c) {
    if (JSFun.isNumber(c) && c > -1 && c < this._figures.length) {
        if (this._selectedFigure == c) {
            return false
        }
        ...
        if (this._figures[c] instanceof FromImageFigure) {
            ...
            this._beforeHeight = this._height;
            this._beforeWidth = this._width;
            this._nodeChilds[this._nodeChilds.length - 1]._beforeHeight = this._nodeChilds[this._nodeChilds.length - 1]._height;
            this._nodeChilds[this._nodeChilds.length - 1]._beforeWidth = this._nodeChilds[this._nodeChilds.length - 1]._width;
            for (a = 0; a < this._nodeChilds.length; a++) {
                this._nodeChilds[a].setVisibility(false)
            }
        } else {
            ...
            this.setHeight(this._beforeHeight);
            this.setWidth(this._beforeWidth);
            this._nodeChilds[this._nodeChilds.length - 1].setHeight(this._nodeChilds[this._nodeChilds.length - 1]._beforeHeight);
            this._nodeChilds[this._nodeChilds.length - 1].setWidth(this._nodeChilds[this._nodeChilds.length - 1]._beforeWidth);
            this._beforeHeight = 0;
            this._beforeWidth = 0;
            this.notifyChange(true);
