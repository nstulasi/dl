	...
	$(function() {
		...
		var u = navigator.userAgent.toLowerCase(),
			...
			css_string = '' + 
				...
				'.jstree a { display:inline-block; line-height:16px; height:16px; color:black; white-space:nowrap; text-decoration:none; font-size:14px;padding:1px 2px; margin:0; } ' + 
		...
		if(/msie/.test(u) && parseInt(v, 10) == 6) { 
			...
			css_string += '' + 
				...
				'.jstree li a { display:inline; border-width:0 !important; padding:10px 2px !important; } ' + 
